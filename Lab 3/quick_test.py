"""
Versión rápida del renderizador para testing - Resolución menor
"""
...
# Configuración de resolución menor para rapidez
WIDTH, HEIGHT = 400, 300  # Resolución más pequeña para testing rápido
...
def render_shot(renderer: Renderer, model: Model, camera: Camera, 
    ...
    if save_bmp:
        filename = f"{shot_name.lower().replace(' ', '_')}_quick.bmp"
...
def main():
    ...
    print("🎬 Renderizador Rápido de Prueba (400x300)")
    print("=" * 50)
    ...
    print(f"📊 Modelo: {len(model.vertices)//3} vértices")
    ...
    print("\n🎥 Generando las 4 tomas (resolución 400x300)...")
    print("-" * 30)
    
    # Crear ventana para mostrar resultados
    screen = pygame.display.set_mode((WIDTH * 2, HEIGHT * 2))
    pygame.display.set_caption("Test Rápido - 4 Tomas")
    ...
    print("\n📁 Archivos generados (resolución de prueba):")
    print("- medium_shot_quick.bmp")
    print("- low_angle_quick.bmp") 
    print("- high_angle_quick.bmp")
    print("- dutch_angle_quick.bmp")
